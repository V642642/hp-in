...
export default function EBenifits() {
  ...
  return (
    ...
    <div className="w-full lg:w-8/12 md:w-11/12  flex items-center justify-center gap-6 flex-col md:flex-row px-2">
      ...
      <div className="w-full md:w-3/12 flex items-center justify-center  flex-col">
        <Image src={`${process.env.NEXT_PUBLIC_S3_URL}/images/hassle-free.webp`} alt="images" className="w-[90px]" width={90} height={90} />
      ...
      <div className="w-full md:w-3/12 flex items-center justify-center  flex-col">
        <Image src={`${process.env.NEXT_PUBLIC_S3_URL}/images/single-window.webp`} alt="images" className="w-[90px]" width={90} height={90} />
    ...
    <div className="w-full lg:w-8/12 md:w-11/12 flex items-center justify-center flex-col md:flex-row gap-6 px-2">
      <div className="w-full md:w-3/12 flex items-center justify-center  flex-col">
        <Image src={`${process.env.NEXT_PUBLIC_S3_URL}/images/cloud.webp`} alt="images" className="w-[90px]" width={90} height={90} />
      ...
      <div className="w-full md:w-3/12 flex items-center justify-center  flex-col">
        <Image src={`${process.env.NEXT_PUBLIC_S3_URL}/images/organise.webp`} alt="images" className="w-[90px]" width={90} height={90} />
      ...
      <div className="w-full md:w-3/12 flex items-center justify-center  flex-col">
        <Image src={`${process.env.NEXT_PUBLIC_S3_URL}/images/vendor.webp`} alt="images" className="w-[90px]" width={90} height={90} />
      ...
      <div className="w-full md:w-3/12 flex items-center justify-center  flex-col">
        <Image src={`${process.env.NEXT_PUBLIC_S3_URL}/images/Intelligence.webp`} alt="images" className="w-[90px]" width={90} height={90} />
